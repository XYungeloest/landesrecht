...
| sicher zurückgerechnet | 13 | **44** |
| davon einstufig (Rezept v1) | 13 | 37 |
| davon mehrstufig (Rezept v2) | 0 | 7 |
| `reconstruction-required` | 506 | 475 |
...
| ---: | --- | ---: | ---: | ---: | --- |
| 1 | genau 1 Änderung nach dem Stichtag (`single-amendment`) | 60 | 37 | 23 | `command-unreadable/chain-block-not-found` 8, `unsupported-formula/unrecognized` 3, `partial-chain/baseline-text-in-force-unproven` 2, `unsupported-formula/insert-unit` 2 |
| 2 | 2 Änderungen (`two-amendments`) | 12 | 6 | 6 | `command-unreadable/location-unreadable` 1, `effective-date-undetermined/commencement-unreadable` 1, `partial-chain/chain-ledger-unexplained` 1, `round-trip-failed/reverse-target-not-found` 1 |
| 3 | 3 oder mehr Änderungen (`three-or-more-amendments`) | 8 | 1 | 7 | `partial-chain/chain-ledger-unexplained` 2, `command-unreadable/chain-block-not-found` 1, `missing-base/prior-source-unavailable` 1, `unsupported-formula/insert-unit` 1 |
| 4 | vollständige Neufassung (`full-recast`) | 5 | 0 | 5 | `non-invertible-amendment/recast` 2, `ambiguous-target/reverse-location-unresolved` 1, `command-unreadable/chain-block-not-found` 1, `partial-chain/chain-delayed-predecessor` 1 |
| 5 | Anlagenersetzung (`annex-replacement`) | 81 | 0 | 81 | `asset-missing/annex-recast` 27, `partial-chain/chain-ledger-unexplained` 11, `non-invertible-amendment/recast` 8, `command-unreadable/location-unreadable` 6 |
| 6 | Tabellenersetzung (`table-replacement`) | 12 | 0 | 12 | `non-invertible-amendment/recast` 5, `partial-chain/chain-commencement-order` 2, `command-unreadable/chain-block-not-found` 1, `command-unreadable/location-unreadable` 1 |
| 7 | Bildersetzung (`image-replacement`) | 5 | 0 | 5 | `non-invertible-amendment/recast` 2, `command-unreadable/location-unreadable` 1, `non-invertible-amendment/delete-words` 1, `non-invertible-amendment/repeal-unit` 1 |
| 8 | fehlender Vorgängertext (`missing-predecessor-text`) | 289 | 0 | 289 | `non-invertible-amendment/recast` 103, `non-invertible-amendment/delete-words` 50, `non-invertible-amendment/repeal-unit` 48, `partial-chain/chain-ledger-unexplained` 18 |
| 9 | baseline-only predecessor (`baseline-only-predecessor`) | 7 | 0 | 7 | `missing-base/no-post-baseline-event` 7 |
| 10 | contradictory evidence (`contradictory-evidence`) | 40 | 0 | 40 | `contradictory/portal-in-force-mismatch` 25, `contradictory/chain-prior-history-mismatch` 4, `contradictory/chain-history-mismatch` 3, `contradictory/chain-no-post-baseline-amendment` 3 |
...
| --- | ---: | ---: | ---: |
| alle genannten Verkündungen verfügbar (Cache, HTML oder PDF-Textlayer) | 494 | 23 | 2 |
| Kette belegt: Vollzitat, Verweise, Register, Verlauf, Fortführungsnachweis, übrige Verkündungen | 353 | 146 | 20 |
| Inkrafttreten je Änderung bestimmt, in Kettenreihenfolge, jüngstes = inkraft | 353 | 18 | 148 |
| Befehlsblock und Orte lesbar | 331 | 22 | 166 |
| jede Klausel mit unterstützter, eindeutig umkehrbarer Formel | 60 | 293 | 166 |
| Orte aufgelöst, Wortlaut eindeutig, Vorwärtsprobe je Änderung exakt | 46 | 14 | 459 |
| Beginn der Stichtagsfassung (≤ Stichtag) mit Kalenderdatum belegt | 44 | 2 | 473 |

## Zustände

| Zustand | Normen | Bedeutung |
| --- | ---: | --- |
| `non-invertible-amendment` | 230 | Befehl nicht umkehrbar (Alttext fehlt) |
| `partial-chain` | 67 | Kette nicht vollständig belegt |
| `recipe-ready` | 44 | sicher zurückgerechnet (Rezept, Forward-Replay exakt) |
| `command-unreadable` | 42 | Befehl nicht auffindbar oder nicht lesbar |
| `contradictory` | 40 | Belege widersprechen einander |
| `asset-missing` | 27 | Anlage oder Abbildung ohne Alttext |
| `missing-base` | 23 | Quelle fehlt |
| `effective-date-undetermined` | 18 | Inkrafttreten nicht bestimmbar |
| `unsupported-formula` | 15 | Formel nicht maschinell angewandt |
| `ambiguous-target` | 10 | Ort oder Wortlaut nicht eindeutig |
| `round-trip-failed` | 3 | Rundlauf gescheitert |
...
| --- | ---: |
| `non-invertible-amendment/recast` | 120 |
| `non-invertible-amendment/delete-words` | 56 |
| `non-invertible-amendment/repeal-unit` | 54 |
| `recipe-ready/reverse-amendment-verified` | 44 |
| `partial-chain/chain-ledger-unexplained` | 33 |
| `asset-missing/annex-recast` | 27 |
| `contradictory/portal-in-force-mismatch` | 25 |
| `command-unreadable/location-unreadable` | 22 |
| `command-unreadable/chain-block-not-found` | 20 |
| `partial-chain/chain-commencement-order` | 20 |
| `effective-date-undetermined/commencement-unreadable` | 18 |
| `missing-base/prior-source-not-on-platform` | 14 |
| `missing-base/no-post-baseline-event` | 8 |
| `unsupported-formula/unrecognized` | 8 |
| `ambiguous-target/reverse-location-unresolved` | 6 |
| `unsupported-formula/insert-unit` | 5 |
| `contradictory/chain-prior-history-mismatch` | 4 |
...
| `round-trip-failed/reverse-target-not-found` | 3 |
| `ambiguous-target/reverse-end-not-determined` | 2 |
| `contradictory/norm-published-after-baseline` | 2 |
| `contradictory/portal-in-force-unexplained` | 2 |
| `partial-chain/baseline-text-in-force-unproven` | 2 |
...
| --- | --- | ---: | ---: | :---: | :---: |
| `replace-words` | „… wird die Angabe „X“ durch die Angabe „Y“ ersetzt“ | 1369 | 235 | ja | ja |
| `recast` | „… wird wie folgt gefasst:“ / „erhält folgende Fassung“ | 609 | 208 | nein | nein |
| `relabel` | „Der bisherige Abs. 3 wird Abs. 4.“ / „Die bisherigen Nrn. 5 bis 7 werden die Nrn. 6 bis 8.“ (neu) | 407 | 117 | ja | ja |
| `repeal-unit` | „… wird aufgehoben“ / „Satz 5 wird gestrichen“ | 327 | 148 | nein | nein |
| `insert-words` | „… wird nach/vor der Angabe „X“ die Angabe „Y“ eingefügt“ | 325 | 116 | ja | ja |
| `unrecognized` | nicht erkannt | 317 | 95 | ja | nein |
| `delete-words` | „… wird die Angabe „X“ gestrichen“ (ohne Anker) | 301 | 123 | nein | nein |
| `insert-sentence` | „Folgender Satz 2 wird angefügt: „²…““ / „Nach Satz 1 wird folgender Satz 2 eingefügt“ (neu) | 227 | 103 | ja | ja |
| `insert-block` | „Nach Nr. 4 wird folgende Nr. 5 eingefügt: „5. …““ / „Folgender Abs. 3 wird angefügt“ (neu) | 206 | 120 | ja | ja |
| `renumber-sentence` | „Der bisherige Satz 2 wird Satz 3.“ (neu) | 152 | 67 | ja | ja |
| `insert-unit` | Einfügung eines Glieds, die nicht eindeutig zuzuordnen ist | 114 | 59 | ja | nein |
| `renumber` | Umnummerierung, die nicht eindeutig lesbar ist | 106 | 63 | ja | nein |
| `insert-title` | „In § 5 wird folgende Überschrift eingefügt: „…““ (neu) | 35 | 7 | ja | ja |
| `replace-final-punctuation` | „… wird der Punkt am Ende durch … ersetzt“ | 33 | 26 | ja | ja |
| `number-sentences` | „Der Wortlaut wird Satz 1.“ (neu) | 31 | 28 | ja | ja |
| `annex-recast` | „… erhalten die aus dem Anhang ersichtliche Fassung“ | 30 | 29 | nein | nein |
| `replace-final-words` | „… wird die Angabe „X“ am Ende durch die Angabe „Y“ ersetzt“ (neu) | 26 | 20 | ja | ja |
| `append-words` | „Der Überschrift wird die Angabe „Y“ angefügt“ | 21 | 17 | ja | ja |
| `replace-by-punctuation` | „… das Wort „oder“ durch ein Komma ersetzt“ (ohne „am Ende“) | 12 | 7 | ja | ja |
| `delete-words-anchored` | „… wird nach/vor der Angabe „X“ die Angabe „Y“ gestrichen“ | 8 | 7 | ja | ja |
| `number-paragraph` | „Der Wortlaut wird Abs. 1.“ (Run 5) | 4 | 4 | ja | ja |
| `container` | „Art. 5 wird wie folgt geändert:“ (Gliederung) | 1 | 1 | ja | nein |

## Quellen

Das Quellenregister führt **854** Verkündungen (851 HTML-Detailseiten, 3 PDF-Ausgaben), davon 68 für ein Rezept entscheidend; Amtlichkeit: `electronic-official` 371, `printed-official` 483. Je Quelle: Adresse, Fundstelle, Verkündungs- und Ausfertigungsdatum, Amtlichkeit, SHA-256, Rolle je Fall, Abschnitt und Wortlaut der Inkrafttretensvorschrift.

Gezielter Abruf (`reconstruction-queue --fetch`, Prüfpunkt `data/imports/bayernrecht/reconstruction-fetch.json`): **401** Netzabrufe (385 Seiten bzw. PDF abgerufen, 16 belegt nicht vorhanden – 404, 0 Fehler), sequenziell über den Adapter-Fetcher mit Cache und identifizierendem User-Agent. Ein Wiederholungslauf mit `--offline` braucht kein Netz.
...
| `BayVV_2235_1_1_5_K_13224` | BayMBl. 2024 Nr. 442 (Nr. 1) | – (Stammfassung) | Beginn der Stichtagsfassung (Stammfassung) nicht belegt: Inkrafttreten der Stammfassung ohne Kalenderdatum: „Diese Bekanntmachung tritt für das neunjährige Gymnasium mir Wirkung vom 1. August 2022 in Kraft.“ |
...
### genau 1 Änderung nach dem Stichtag (23)
...
| `BayVV_2235_1_1_5_K_13224` | 1 | `partial-chain/baseline-text-in-force-unproven` | Beginn der Stichtagsfassung (Stammfassung) nicht belegt: Inkrafttreten der Stammfassung ohne Kalenderdatum: „Diese Bekanntmachung tritt für das neunjährige Gymnasium mir Wirkung vom 1. August 2022 in  |  |
...
| `BayVV_301_I_2284` | 1 | `unsupported-formula/insert-unit` | BayMBl. 2024 Nr. 484 (Nr. 1): 1.2 1.2.1 1.2.1.3 „Folgender Spiegelstrich 7 wird angefügt:“: Einfügung eines ganzen Glieds (Satz, Absatz, Nummer, Überschrift): strukturelle Änderung, von diesem Modell  | `unrecognized` |
...
| `ARDStV` | 0 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 350 (Art. 2): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
| `BayDLR_StV` | 0 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 350 (Art. 4): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
| `JMStV` | 0 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 396 (Art. 1): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
| `RFinStV` | 0 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 350 (Art. 5): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
| `ZDF_StV` | 0 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 350 (Art. 3): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
...
| `BayLFBPO` | 2 | `unsupported-formula/replace-words` | GVBl. 2024 S. 98 (§ 1): „In der Überschrift und in § 2 Abs. 5 werden die Wörter „und Forsten“ durch die Wörter „ , Forsten und Tourismus“ ersetzt.“: Mehrere Orte (Überschrift; § 2 Abs. 5) ohne „jeweil |  |
| `BayVV_2210_4_WK_14107` | 2 | `unsupported-formula/unrecognized` | BayMBl. 2024 Nr. 438 (Nr. 1): 1.1 „In Nr. 1 wird nach Satz 5 die Nr. 1.1 eingefügt. Die bisherigen Sätze 6 und 7 der Nr. 1 werden die Sätze 1 und 2 der Nr. 1.1.“: Mehrere Sätze in einem Befehl; der Or |  |
| `BayUIG` | 2 | `round-trip-failed/reverse-target-not-found` | GVBl. 2024 S. 605 (§ 10): 2. Art. 2 Abs. 1 (Schlusstext hinter der Aufzählung): eingefügter Satz „²Der Oberste Rechnungshof ist außer in Bezug auf seine eigene Verwaltungsführung“ steht 0-mal an der g |  |
...
| `BayGesV` | 4 | `partial-chain/chain-ledger-unexplained` | Das Register führt GVBl. 2024 S. 98 (new) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichung nicht |  |
...
| `BayVV_2033_6_F_10463` | 3 | `unsupported-formula/insert-unit` | BayMBl. 2026 Nr. 58 (§ 1): 2. „In Buchst. a wird der Tabelle folgende Angabe angefügt:“: Einfügung eines ganzen Glieds (Satz, Absatz, Nummer, Überschrift): strukturelle Änderung, von diesem Modell nic |  |
| `MStV` | 7 | `command-unreadable/chain-block-not-found` | GVBl. 2025 S. 396 (Art. 2): kein eindeutig lesbarer Änderungsbefehl für die Norm (intro-not-found: Kein Einleitungssatz zitiert die Norm mit einem Änderungsbefehl); die Änderung tritt nach dem Stichta |  |
...
| `BayAgrSchO` | 4 | `partial-chain/chain-ledger-unexplained` | Das Register führt GVBl. 2024 S. 98 (new) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichung nicht | `annex-replacement`, `missing-predecessor-text` |
...
| `BayWSO` | 5 | `partial-chain/chain-ledger-unexplained` | Das Register führt GVBl. 2026 S. 335 (amend) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichung nicht | `annex-replacement`, `table-replacement`, `missing-predecessor-text` |
...
| `BayBFSO2023` | 7 | `partial-chain/chain-ledger-unexplained` | Das Register führt GVBl. 2026 S. 335 (amend) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichung nicht | `annex-replacement`, `missing-predecessor-text` |
...
| `VVBayHO` | 1 | `command-unreadable/chain-block-not-found` | BayMBl. 2025 Nr. 590 (§ 1): kein eindeutig lesbarer Änderungsbefehl für die Norm (structure-unreadable: Ein Zitat wird bis zum Ende der Seite nicht geschlossen); die Änderung tritt nach dem Stichtag i | `annex-replacement`, `image-replacement`, `missing-predecessor-text` |
...
| `BayVV_7912_4_U_11130` | 2 | `command-unreadable/location-unreadable` | BayMBl. 2024 Nr. 593 (Nr. 1): Ortsangabe „Einführung“ nicht lesbar (1.1) | `annex-recast`, `delete-words`, `recast`, `repeal-unit`, `insert-unit`, `renumber`, `annex-replacement`, `missing-predecessor-text` |
...
| `BayFOBOSO` | 5 | `command-unreadable/location-unreadable` | GVBl. 2026 S. 335 (§ 7): Ortsangabe „Tabelle der Anlage 3“ nicht lesbar (13.) | `repeal-unit`, `delete-words`, `recast`, `renumber`, `unrecognized`, `insert-unit`, `annex-replacement`, `table-replacement`, `missing-predecessor-text` |
...
| `BayVPSW` | 1 | `non-invertible-amendment/repeal-unit` | GVBl. 2025 S. 166 (§ 1): 1. b) cc) „Buchst. c wird aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `delete-words`, `recast`, `insert-unit`, `annex-replacement`, `missing-predecessor-text` |
...
| `BayVwV233866` | 2 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 529 (Nr. 1): 1.2 „Nr. 2 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `annex-replacement`, `table-replacement`, `missing-predecessor-text` |
| `BayVwV235144` | 2 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 526 (Nr. 1): 1.2 „Nr. 2 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `annex-replacement`, `table-replacement`, `missing-predecessor-text` |
...
| `BayFakO` | 8 | `non-invertible-amendment/delete-words` | GVBl. 2026 S. 335 (§ 8): 2. a) „In Abs. 1 Satz 2 wird die Angabe „innerhalb der vergangenen drei Jahre“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `repeal-unit`, `insert-unit`, `unrecognized`, `annex-replacement`, `missing-predecessor-text` |
...
| `BayFachVVI` | 1 | `asset-missing/annex-recast` | GVBl. 2024 S. 537 (§ 1): 45. „Die Anlage aus dem Anhang zu dieser Verordnung wird angefügt.“: Anlage oder Anhang in neuer Fassung aus einer beigefügten Datei; der Alttext steht nicht im Befehl | `repeal-unit`, `recast`, `delete-words`, `insert-unit`, `unrecognized`, `renumber`, `replace-words`, `relabel`, `annex-replacement`, `missing-predecessor-text` |
| `BayGesVSV` | 1 | `asset-missing/annex-recast` | GVBl. 2025 S. 17 (§ 1): 7. „Die aus dem Anhang zu dieser Verordnung ersichtliche Anlage 2 wird angefügt.“: Anlage oder Anhang in neuer Fassung aus einer beigefügten Datei; der Alttext steht nicht im B | `delete-words`, `renumber`, `annex-replacement` |
...
| `BayVV_34_I_12346` | 1 | `asset-missing/annex-recast` | BayMBl. 2025 Nr. 276 (Nr. 1): 1.27 „Die Anlagen 1 bis 5 erhalten die aus dem Anhang zu dieser Bekanntmachung ersichtliche Fassung.“: Anlage oder Anhang in neuer Fassung aus einer beigefügten Datei; de | `delete-words`, `recast`, `unrecognized`, `replace-words`, `annex-replacement`, `missing-predecessor-text` |
| `BayVV_7803_2_L_10838` | 1 | `asset-missing/annex-recast` | BayMBl. 2025 Nr. 43 (Nr. 1): 1.4 „Die bisherige Anlage wird durch die Anlage dieser Bekanntmachung ersetzt.“: Anlage durch eine beigefügte Anlage ersetzt; der Alttext steht nicht im Befehl | `recast`, `annex-replacement`, `missing-predecessor-text` |
| `BayVV_787_L_13483` | 1 | `asset-missing/annex-recast` | BayMBl. 2025 Nr. 575 (Nr. 1): 1.13 „Die bisherige Anlage wird durch die Anlage dieser Bekanntmachung ersetzt.“: Anlage durch eine beigefügte Anlage ersetzt; der Alttext steht nicht im Befehl | `repeal-unit`, `recast`, `unrecognized`, `insert-unit`, `annex-replacement`, `missing-predecessor-text` |
...
| `BayVV_7846_L_13701` | 1 | `command-unreadable/location-unreadable` | BayMBl. 2025 Nr. 481 (Nr. 1): Ortsangabe „Fußnote Nr. 3“ nicht lesbar (1.5 1.5.3) | `recast`, `delete-words`, `insert-unit`, `unrecognized`, `table-replacement`, `missing-predecessor-text` |
...
| `BayVV_2273_I_13469` | 2 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 565 (Nr. 1): 1.1 „Nr. 4.1.1 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `repeal-unit`, `table-replacement`, `missing-predecessor-text` |
| `BayVV_7071_W_10501` | 2 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 543 (Nr. 1): 1.1 „Die Tabelle in Nr. 6.1 erster Spiegelstrich wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `table-replacement`, `missing-predecessor-text` |
...
| `BayVV_7071_W_10425` | 3 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 541 (Nr. 1): 1.1 „Die Tabelle in Nr. 6.1.1 erster Spiegelstrich wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `table-replacement`, `missing-predecessor-text` |
...
| `BayVV_2010_K_13179` | 2 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 127 (Nr. 1): 1.2 1.2.1 „Die Sätze 1 und 2 werden wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `delete-words`, `repeal-unit`, `image-replacement`, `missing-predecessor-text` |
| `BayVV_2253_D_12831` | 2 | `non-invertible-amendment/delete-words` | BayMBl. 2026 Nr. 247 (§ 1): 5. „In den Nrn. 3.2 und Nr. 3.3 Satz 2 wird jeweils die Angabe „in Vollzeit“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `repeal-unit`, `renumber`, `insert-unit`, `unrecognized`, `relabel`, `image-replacement`, `missing-predecessor-text` |
...
| `BayFachVVermGeo` | 3 | `partial-chain/chain-ledger-unexplained` | Das Register führt GVBl. 2025 S. 2 (amend), GVBl. 2025 S. 2 (expire) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichungen nicht | `missing-predecessor-text` |
...
| `BayVV_787_L_13932` | 4 | `partial-chain/chain-ledger-unexplained` | Das Register führt BayMBl. 2024 Nr. 48 (amend) für die Norm; die Kette der amtlichen Verweise enthält diese Veröffentlichung nicht | `missing-predecessor-text` |
...
| `BayZustVFM` | 2 | `ambiguous-target/reverse-location-unresolved` | GVBl. 2024 S. 564 (§ 1): 2. a) § 7 Abs. 3: Abs. 3 mehrfach vorhanden | `missing-predecessor-text` |
...
| `BayZAPOFI` | 2 | `round-trip-failed/reverse-target-not-found` | GVBl. 2025 S. 272 (§ 14): 1. b) § 4 Abs. 1 (Schlusstext hinter der Aufzählung): eingefügter Satz „²Die Kosten für ärztliche Gutachten hat die Bewerberin oder der Bewerber zu trag“ steht 0-mal an der g | `missing-predecessor-text` |
...
| `BayMaxOStat` | 1 | `effective-date-undetermined/commencement-unreadable` | GVBl. 2007 S. 640: S. 640–640 enthalten 1 Inkrafttretensregeln; verlangt ist genau eine Grundregel mit Kalenderdatum | `missing-predecessor-text` |
| `BayWkKV` | 1 | `effective-date-undetermined/commencement-unreadable` | GVBl. 2007 S. 707 (§ 4): S. 707–717 enthalten 1 Inkrafttretensregeln; verlangt ist genau eine Grundregel mit Kalenderdatum | `missing-predecessor-text` |
| `BayWkPV` | 1 | `effective-date-undetermined/commencement-unreadable` | GVBl. 2007 S. 707 (§ 5): S. 707–717 enthalten 1 Inkrafttretensregeln; verlangt ist genau eine Grundregel mit Kalenderdatum | `missing-predecessor-text` |
...
| `BayFoStS` | 1 | `command-unreadable/location-unreadable` | GVBl. 2025 S. 122 (§ 1): Ortsangabe des Einleitungssatzes nicht lesbar: „Die Satzung“ | `recast`, `repeal-unit`, `delete-words`, `unrecognized`, `renumber`, `replace-words`, `missing-predecessor-text` |
...
| `BayVwV294809` | 2 | `command-unreadable/location-unreadable` | BayMBl. 2025 Nr. 311 (Nr. 1): Ortsangabe „Einleitungsformel“ nicht lesbar (1.1) | `delete-words`, `repeal-unit`, `recast`, `insert-unit`, `unrecognized`, `missing-predecessor-text` |
...
| `BayVwV154721` | 1 | `missing-base/prior-source-not-on-platform` | Die genannte Änderung „vom 13. Oktober 2017 (KWMBl. S. 439)“ ist nicht im GVBl. oder BayMBl. verkündet; ihre Verkündung ist auf der Verkündungsplattform nicht abrufbar | `missing-predecessor-text` |
...
| `BayVwV252304` | 1 | `missing-base/prior-source-not-on-platform` | Die genannte Änderung „vom 28. August 2017 (JMBl. S. 197)“ ist nicht im GVBl. oder BayMBl. verkündet; ihre Verkündung ist auf der Verkündungsplattform nicht abrufbar | `missing-predecessor-text` |
...
| `BayAbfZustV` | 1 | `non-invertible-amendment/delete-words` | GVBl. 2024 S. 458 (§ 2): 1. a) „In der Überschrift wird das Wort „ , Außerkrafttreten“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `repeal-unit`, `recast`, `renumber`, `unrecognized`, `insert-unit`, `missing-predecessor-text` |
...
| `BayLPO_I` | 1 | `non-invertible-amendment/delete-words` | GVBl. 2025 S. 58 (§ 1): 2. „In § 3 Abs. 3 Satz 2 wird das Wort „Neugriechisch,“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `repeal-unit`, `unrecognized`, `replace-by-punctuation`, `insert-unit`, `renumber`, `missing-predecessor-text` |
...
| `BayVV_2013_2_F_13526` | 1 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 258 (§ 1): 2. „Die Nrn. 3.3 und 3.4 werden wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `delete-words`, `repeal-unit`, `renumber`, `unrecognized`, `missing-predecessor-text` |
...
| `BayVV_2038_3_11_G_13478` | 1 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 391 (Nr. 1): 1.6 „Nr. 3 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `insert-unit`, `missing-predecessor-text` |
...
| `BayVV_2126_0_G_12665` | 1 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 528 (Nr. 1): 1.3 „Nr. 5.4 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `missing-predecessor-text` |
...
| `BayVV_2130_0_F_13459` | 1 | `non-invertible-amendment/repeal-unit` | BayMBl. 2025 Nr. 189 (§ 1): 4. a) „Satz 6 wird aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `recast`, `delete-words`, `unrecognized`, `missing-predecessor-text` |
| `BayVV_2162_A_10911` | 1 | `non-invertible-amendment/delete-words` | BayMBl. 2024 Nr. 644 (Nr. 1): 1.2 1.2.1 „In Satz 1 wird das Wort „verbindlicher“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `repeal-unit`, `replace-words`, `missing-predecessor-text` |
...
| `BayVV_2174_A_13397` | 1 | `non-invertible-amendment/repeal-unit` | BayMBl. 2026 Nr. 268 (Nr. 1): 1.4 1.4.1 1.4.1.2 „Die Sätze 3 und 7 werden aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `renumber`, `unrecognized`, `missing-predecessor-text` |
| `BayVV_2175_4_G_10792` | 1 | `non-invertible-amendment/delete-words` | BayMBl. 2024 Nr. 452 (Nr. 1): 1.1 „In Nr. 1.2 Buchst. b werden die Wörter „Teils 3 des“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `repeal-unit`, `recast`, `renumber`, `replace-words`, `unrecognized`, `missing-predecessor-text` |
...
| `BayVV_2230_1_1_1_1_K_13367` | 1 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 128 (Nr. 1): 1.2 „Nr. 1 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `repeal-unit`, `delete-words`, `unrecognized`, `missing-predecessor-text` |
| `BayVV_2230_1_1_1_2_4_K_11098` | 1 | `non-invertible-amendment/delete-words` | BayMBl. 2026 Nr. 356 (Nr. 1): 1.4 1.4.2 1.4.2.1 „Im dritten Spiegelstrich wird die Angabe „ab 1. März 2020“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `repeal-unit`, `missing-predecessor-text` |
...
| `BayVV_66_F_11402` | 1 | `non-invertible-amendment/recast` | BayMBl. 2024 Nr. 456 (§ 1): 4. a) „Satz 1 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `delete-words`, `repeal-unit`, `renumber`, `unrecognized`, `replace-words`, `missing-predecessor-text` |
...
| `BayVV_7012_1_F_12963` | 1 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 188 (§ 1): 1. a) „Die Überschrift wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `repeal-unit`, `delete-words`, `unrecognized`, `insert-unit`, `missing-predecessor-text` |
...
| `BayVV_7523_W_13569` | 1 | `non-invertible-amendment/delete-words` | BayMBl. 2025 Nr. 544 (Nr. 1): 1.1 „In der Vorbemerkung wird in Satz 1 die Angabe „Bestimmungen“ durch die Angabe „Vorschriften“ ersetzt und die Angabe „(VV)“ gestrichen.“: Klausel nicht erkannt: „wird | `repeal-unit`, `recast`, `missing-predecessor-text` |
...
| `BayVV_7803_1_L_10832` | 1 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 75 (Nr. 1): 1.9 „Der Spiegelstrich erhält folgende neue Fassung:“: Neufassung; der Alttext steht nicht im Befehl | `insert-unit`, `unrecognized`, `renumber`, `missing-predecessor-text` |
...
| `BayVwV257012` | 1 | `non-invertible-amendment/repeal-unit` | BayMBl. 2024 Nr. 362 (§ 1): 1. „Die Nrn. 1.1.3 bis 1.1.5 werden aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `recast`, `unrecognized`, `missing-predecessor-text` |
...
| `BayVwV294820` | 1 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 92 (§ 1): 2. „Nr. 1.2 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `repeal-unit`, `delete-words`, `unrecognized`, `missing-predecessor-text` |
...
| `BayVV_2126_0_G_11745` | 2 | `non-invertible-amendment/repeal-unit` | BayMBl. 2025 Nr. 206 (Nr. 1): 1.6 1.6.1 1.6.1.2 „Die Sätze 2 und 3 werden aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `recast`, `insert-unit`, `renumber`, `missing-predecessor-text` |
| `BayVV_2160_A_11301` | 2 | `non-invertible-amendment/recast` | BayMBl. 2026 Nr. 280 (Nr. 1): 1.2 „Nr. 5 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `repeal-unit`, `insert-unit`, `missing-predecessor-text` |
...
| `BayVV_3122_2_0_J_10825` | 2 | `non-invertible-amendment/delete-words` | BayMBl. 2024 Nr. 573 (Nr. 1): 1.3 1.3.1 „In Spiegelstrich 1 werden die Wörter „und die Arbeitslosenversicherung“ gestrichen.“: Streichung ohne Anker: der Wortlaut ist bekannt, die Stelle nicht | `recast`, `missing-predecessor-text` |
...
| `BayVV_7070_W_11463` | 2 | `non-invertible-amendment/recast` | BayMBl. 2025 Nr. 542 (Nr. 1): 1.1 „Nr. 8 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `missing-predecessor-text` |
...
| `BayZAPOJ` | 2 | `non-invertible-amendment/recast` | GVBl. 2026 S. 564 (§ 1): 4. a) „Abs. 1 wird wie folgt gefasst:“: Neufassung; der Alttext steht nicht im Befehl | `delete-words`, `missing-predecessor-text` |
...
| `BayZustVWFKM` | 2 | `non-invertible-amendment/repeal-unit` | GVBl. 2025 S. 197 (§ 1): 1. c) „Nr. 3 wird aufgehoben.“: Aufhebung; der aufgehobene Wortlaut steht nicht im Befehl | `recast`, `delete-words`, `unrecognized`, `renumber`, `missing-predecessor-text` |
...
| `BayVV_2230_1_1_1_0_K_14216` | 1 | `contradictory/norm-published-after-baseline` | Die Norm selbst ist erst nach dem Stichtag verkündet: BayMBl. 2023 Nr. 633 (eigene Fundstelle, Register: expire am 2023-12-20); am Stichtag gab es diese Fassung nicht – die Einstufung „am Stichtag in  |  |
...
| `BayVV_2330_B_14207` | 2 | `contradictory/norm-published-after-baseline` | Die Norm selbst ist erst nach dem Stichtag verkündet: BayMBl. 2023 Nr. 629 (eigene Fundstelle, Register: expire am 2023-12-20); am Stichtag gab es diese Fassung nicht – die Einstufung „am Stichtag in  |  |
...
| `BayVV_7071_W_10524` | 4 | `contradictory/portal-in-force-mismatch` | Der heutige Text gilt laut Paket seit 2025-07-01, die jüngste Änderung BayMBl. 2025 Nr. 506 tritt am 2025-12-31 in Kraft | `missing-predecessor-text` |
