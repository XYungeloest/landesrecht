 ...
 *
 * Es wird keine Kennung erfunden: Der Datensatz hält Adresse, Titel, Fehlergrund, Abrufstatus und Hashes
 * fest, damit jeder enumerierte Eintrag einen nachvollziehbaren Endzustand hat. Schlüssel ist der Hash der
 * Einstiegsadresse (`paths.ts`), nicht eine Ersatzidentität.
 */
...
export const UNRESOLVED_SOURCE_SCHEMA = 'juris-sh-unresolved-source/1' as const;
