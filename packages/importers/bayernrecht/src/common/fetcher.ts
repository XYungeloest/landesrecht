/**
 * Fetcher des BAYERN.RECHT-Adapters – ein dünner Wrapper um den erprobten Fetcher des West-Adapters
 ...
 * Optionen. Dieser Wrapper setzt die Vorgaben des BayWü-Adapters (eigener Cache `.cache/bayernrecht`,
...
export type BayernRechtFetcher = RechtNrwFetcher;

export interface BayernRechtFetcherOptions extends FetcherOptions {
  /** Repository-Root, wenn `cacheDir` nicht ausdrücklich gesetzt ist (Standard: Arbeitsverzeichnis). */
  root?: string;
}

export function createBayernRechtFetcher(options: BayernRechtFetcherOptions = {}): BayernRechtFetcher {
