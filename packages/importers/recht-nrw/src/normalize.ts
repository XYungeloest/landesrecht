...
import type { BodyStats, SourceFootnote } from './body-common.ts';
import { PARSER_VERSION, SOURCE_SYSTEM } from './constants.ts';
import type { FetchedDocument } from './fetcher.ts';
import { parseGermanLongDate, stemIdentifier } from './source-identity.ts';
import type { RechtNrwVersionPage } from './version-page.ts';
